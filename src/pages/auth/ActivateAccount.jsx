...
const ActivateAccount = ({ className, ...props }) => {
    ...
    return (
        <div className={cn("relative w-screen h-screen overflow-hidden", className)} {...props}>
            ...
            {/* Overlay Container with Translucent Dark/Muted Backdrop */}
                                ...
                                <FieldGroup>
                                    <div className="flex flex-col items-center gap-2 text-center">
                                        ...
                                        <p className="text-balance text-muted-foreground">
                                            Enter your assigned Teacher ID to verify your record and set up your login credentials.
                                        </p>
                                    </div>
                                    <Field>
                                        <FieldLabel htmlFor="teacher-id">Teacher's ID</FieldLabel>
                                        <InputGroup>
                                            <InputGroupInput
                                                id="teacher-id"
                                                type="text"
                                    ...
                                    <FieldDescription className="text-center">
                                        Already have an account? <Link to="/">Login you account</Link>
                                    </FieldDescription>
                                </FieldGroup>
                            </form>
                        </CardContent>
